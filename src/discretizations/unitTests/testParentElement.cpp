...
constexpr void compileTimeCheck()
{
  ...
  constexpr int order = TestParentElementHelperType::order;
        ...
        constexpr double coord[3] = { TestParentElementHelperType::testParentCoords[0],
                                      TestParentElementHelperType::testParentCoords[1],
                                      TestParentElementHelperType::testParentCoords[2] };
        ...
        forSequence< order + 1 >( [&] ( auto const a ) constexpr
        {
          forSequence< order + 1 >( [&] ( auto const b ) constexpr
          {
            forSequence< order + 1 >( [&] ( auto const c ) constexpr
            {
              ...
              static_assert( check( value, TestParentElementHelperType::referenceValues[a][b][c], tolerance ) );
              static_assert( check( gradient[0], TestParentElementHelperType::referenceGradients[a][b][c][0], tolerance ) );
              static_assert( check( gradient[1], TestParentElementHelperType::referenceGradients[a][b][c][1], tolerance ) );
              static_assert( check( gradient[2], TestParentElementHelperType::referenceGradients[a][b][c][2], tolerance ) );
            } );
          } );
        } );
...
constexpr void runTimeCheck()
{
  ...
  constexpr int order = TestParentElementHelperType::order;
        ...
        double const coord[3] = { TestParentElementHelperType::testParentCoords[0],
                                  TestParentElementHelperType::testParentCoords[1],
                                  TestParentElementHelperType::testParentCoords[2] };
        ...
        forSequence< order + 1 >( [&] ( auto const a ) constexpr
        {
          forSequence< order + 1 >( [&] ( auto const b ) constexpr
          {
            forSequence< order + 1 >( [&] ( auto const c ) constexpr
            {
              ...
              EXPECT_NEAR( value, TestParentElementHelperType::referenceValues[a][b][c], fabs( value * tolerance ) );
              EXPECT_NEAR( gradient[0], TestParentElementHelperType::referenceGradients[a][b][c][0], fabs( gradient[0] * tolerance ) );
              EXPECT_NEAR( gradient[1], TestParentElementHelperType::referenceGradients[a][b][c][1], fabs( gradient[1] * tolerance ) );
              EXPECT_NEAR( gradient[2], TestParentElementHelperType::referenceGradients[a][b][c][2], fabs( gradient[2] * tolerance ) );
            } );
          } );
        } );
