...
static double const Xref[8][3] = { { -1.31, -1.15, -1.23 },
                                   {  1.38, -1.22, -1.17 },
                                   { -1.31,  1.12, -1.31 },
                                   {  1.32,  1.17, -1.37 },
                                   { -1.23, -1.25,  1.27 },
...
static double const qCoords[8][3] = { { -0.9, -0.5, -0.6 },
                                      { -0.9, -0.5,  0.6 },
                                      { -0.9,  0.5, -0.6 },
                                      { -0.9,  0.5,  0.6 },
                                      {  0.9, -0.5, -0.6 },
...
static double const Jref[8][3][3] = { { { 1.3245,  -6.3e-3,  2.925e-2 }, { -2.375e-2, 1.16365, -1.84375e-2 }, {   8.5e-3, -2.05e-2, 1.275875 } }, 
...
static double const invJref[8][3][3] = { { { 7.5518050317544e-1, 3.7845098812477e-3, -1.725815837519e-2 }, { 1.5337360823102e-2, 8.5966062432681e-1, 1.2071225595728e-2 }, { -4.784652399426e-3, 1.3787302411842e-2, 7.8408476886129e-1 } }, 
                                         ...
                                         { { 7.5799440223966e-1, -2.2947438633317e-2, -7.0656815704294e-3 }, { 1.1224373599541e-2, 7.8761135930028e-1, -7.8704397957213e-3 }, { 1.1764501075278e-2, -1.7597001324914e-2, 7.5456369966319e-1 } } };
