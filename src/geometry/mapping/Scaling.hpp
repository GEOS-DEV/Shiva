...
/**
 * @brief Calculates the inverse Jacobian transformation and detJ for a rectangular cuboid.
 * @tparam REAL_TYPE The floating point type.
 * @param cell The rectangular cuboid for which the inverse Jacobian is calculated.
